...
enum EventsUrl {
  HTTPS_API_GITHUB_COM_USERS_ILIAS_HB_EVENTS_PRIVACY
}

final eventsUrlValues = EnumValues({
  "https://api.github.com/users/iliasHB/events{/privacy}": EventsUrl.HTTPS_API_GITHUB_COM_USERS_ILIAS_HB_EVENTS_PRIVACY
});

enum FollowingUrl {
  HTTPS_API_GITHUB_COM_USERS_ILIAS_HB_FOLLOWING_OTHER_USER
}

final followingUrlValues = EnumValues({
  "https://api.github.com/users/iliasHB/following{/other_user}": FollowingUrl.HTTPS_API_GITHUB_COM_USERS_ILIAS_HB_FOLLOWING_OTHER_USER
});

enum GistsUrl {
  HTTPS_API_GITHUB_COM_USERS_ILIAS_HB_GISTS_GIST_ID
}

final gistsUrlValues = EnumValues({
  "https://api.github.com/users/iliasHB/gists{/gist_id}": GistsUrl.HTTPS_API_GITHUB_COM_USERS_ILIAS_HB_GISTS_GIST_ID
});
...
final loginValues = EnumValues({
  "iliasHB": Login.ILIAS_HB
});

enum NodeId {
  MDQ6_VX_NLCJ_Y5_MJC5_NZKY
}

final nodeIdValues = EnumValues({
  "MDQ6VXNlcjY5Mjc5Nzky": NodeId.MDQ6_VX_NLCJ_Y5_MJC5_NZKY
});

enum StarredUrl {
  HTTPS_API_GITHUB_COM_USERS_ILIAS_HB_STARRED_OWNER_REPO
}

final starredUrlValues = EnumValues({
  "https://api.github.com/users/iliasHB/starred{/owner}{/repo}": StarredUrl.HTTPS_API_GITHUB_COM_USERS_ILIAS_HB_STARRED_OWNER_REPO
});
